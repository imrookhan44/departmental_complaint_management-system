...
function Mid() {
  return (
    <div>
      <div className="" style={{ display: "flex", justifyContent: "space-around", margin: "60px" }} >
        ...
        <div className="col-4">
          <div>
            ...
            <ul>
              <li style={{ listStyle: "none" }}>Your complaint will be auto-acknowledged within 24-hours.</li>
            </ul>
            <br />
            <h2>
              <b>Investigation</b>
